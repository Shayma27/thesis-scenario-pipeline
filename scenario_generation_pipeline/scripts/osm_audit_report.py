...
the 19 reports in data/stage1_extracted/*.json, for manual verification against a real map.
...
Usage:
    python3 scripts/osm_audit_report.py
Output:
...
OUT_JSON = _PROJECT_ROOT / "docs" / "osm_audit_report.json"
OUT_MD = _PROJECT_ROOT / "docs" / "osm_audit_report.md"
