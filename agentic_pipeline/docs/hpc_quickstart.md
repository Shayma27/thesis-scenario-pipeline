...
- **Path mixups from nested directories.** If you're already inside `agentic_pipeline/`, don't prefix paths with `agentic_pipeline/` again. Use `pwd` if unsure where you are.
