...
run_all.py cycles through all 19 reports with esmini viewing and a review
...
output/agentic/*/*.xosc files locally via git, then just watch them here
...
RESULTS_FILE = PROJECT_DIR / "review_results.json"
W = 70
