"""
Scenario Generation Pipeline — core logic.
...
earlier to stage 3 (parameter completion).
...
def _tool_generate_scenario(state: AgentState, parameter_overrides: str | None = None) -> dict:
    ...
    template_src = Path(__file__).resolve().parent.parent / "templates" / xodr_filename
