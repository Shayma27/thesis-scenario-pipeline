...
those belong to Stage 2 (OSM enrichment) and Stage 3 (parameter completion),
which run afterward and read this JSON. This is the only stage in the
pipeline that calls an LLM — everything downstream is deterministic Python.
...
The output JSON is saved to the data/stage1_extracted/ folder, ready to be processed by the pipeline.
"""
