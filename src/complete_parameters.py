"""
Stage 3 — Parameter Completion
=====================================
Fills generated_simulation_parameters.openscenario.actors with concrete
simulation values for all scenario types. Called after Stage 1 (extraction)
and Stage 2 (OSM enrichment). Only fills fields that are still absent —
values set by earlier stages are never overwritten. Deterministic — no LLM
call happens here.
"""
